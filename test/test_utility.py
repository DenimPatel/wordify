...
class TestNumberToCharacterMapping:
    ...
    def test_num_to_chars_mapping():
        """
        Test mapping from Number to list of chars
        """
    ...
    @staticmethod
    def test_num_to_chars_mapping2():
        """
        Test mapping from Number to list of chars for adverserial cases
        """
        assert find_number_to_character_mapping("1") is None
        assert find_number_to_character_mapping("0") is None
        assert find_number_to_character_mapping("Z") is None
        assert find_number_to_character_mapping("@") is None
